	...
	$query = "SELECT * FROM content_manager";
      ...
      if($result)
      {
 		...
 		while($row = mysqli_fetch_assoc($result))
 		{
          ...
          <td><a style="text-decoration:none" href="../delete.php?cm_id=<?php echo $cm_id; ?>"><button id="button">Delete</button></a></td>
          <td><a style="text-decoration:none" href="../block.php?cm_id=<?php echo $cm_id; ?>"><button id="button">Block</button></a></td>
          <td><a style="text-decoration:none" href="../unblock.php?cm_id=<?php echo $cm_id; ?>"><button id="button">Unblock</button></a></td>
        	<?php echo "</tr>"; 
 		}
