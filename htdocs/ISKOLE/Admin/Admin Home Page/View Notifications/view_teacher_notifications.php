...
{
  $main_id = $_GET['id'];
  $sql_update = mysqli_query($con,"UPDATE new_teacher_notifications SET status=1 WHERE id='$main_id'");
}
        ...
        <!-- <script>
            ...
            window.onclick = function(event) {
              ...
              <br>
                        ...
                        <p class="notification_tag"><?php echo $count; ?> Notifications</p>
                        ...
                        <div class="dropdown" style="float: right; padding-top: 25px; padding-right: 20px;">
                          ...
                          <div id="myDropdown" class="dropdown-content">
                            ...
                            <?php 
                              ...
                              if(mysqli_num_rows($sql_get1)>0 || mysqli_num_rows($sql_get2)>0)
                              {
                      ...
                      <div class="row">
                        <table id="notifications" width="100%" border="1">
                          ...
                          <tbody>
                            <?php 
                              $sr_no = 1;
                              $sql_get = mysqli_query($con,"SELECT * FROM new_teacher_notifications WHERE status=1 ORDER BY `cr_date` DESC"); 
                            ...
                            <tr align="center" class="info">
                              ...
                              <td><?php echo $main_result['medium']; ?></td>
                              ...
                              <td><a style="text-decoration:none" href="teacher_accept.php?id=<?php echo $main_result['id']; ?>"><button id="button">Accept</button></a></td>
                              <td><a style="text-decoration:none" href="teacher_decline.php?id=<?php echo $main_result['id']; ?>"><button id="button">Decline</button></a></td>          
                            </tr>
                          <?php endwhile ?>
                          </tbody>
                        </table>
